...
3. Re-run validation rules (`sdd/.agent/rules/intake/02-validation.md`) for impacted mandatory fields.
4. If the change affects behavior or any mandatory field, the agent should pause and ask for explicit re-approval (`approved`) before continuing.
