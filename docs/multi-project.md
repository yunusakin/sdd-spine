...
This repository is designed to be a stable "spine" for a single project. If you need to manage multiple projects, use one of the patterns below.

## Recommended: One Repo Per Project

- Create a new repo per project based on this spine.
...
## Option: Monorepo With One Spine Per Project Folder
...
## Option: Single Spine For Multiple Services (Not Recommended)
